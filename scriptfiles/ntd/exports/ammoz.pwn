...
//Player Textdraws
PlayerTD[playerid][0] = CreatePlayerTextDraw(playerid, 520.000000, 70.000000, "999-29");
PlayerTextDrawFont(playerid, PlayerTD[playerid][0], 1);
PlayerTextDrawLetterSize(playerid, PlayerTD[playerid][0], 0.325000, 1.200000);
...
PlayerTextDrawColor(playerid, PlayerTD[playerid][0], 1687547391);
